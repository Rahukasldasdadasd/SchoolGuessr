...
function buildGameQueue() {
    // Shuffle all rounds and take the first ROUNDS_PER_GAME
    gameQueue = shuffleArray(rounds).slice(0, ROUNDS_PER_GAME);
}
...
function loadRound() {
    ...
    const round = gameQueue[currentRound];
    ...
    roundCounter.textContent =
        `Round ${currentRound + 1} / ${gameQueue.length}`;
...
submitBtn.addEventListener('click', function () {
    ...
    // FINAL ROUND
    if (currentRound === gameQueue.length - 1) {
